...
#
# $Id: database.php,v 1.3.2.1 2005/05/03 22:11:16 filetreefrog Exp $
##################################################
...
(include_once('mysql.php')) or exit('DbInit Failed for some reason');
...
function pathos_database_connect($username,$password,$hostname,$database,$dbclass = '',$new=false) {
	...
	(include_once('mysql.php')) or exit('The specified database backend  ('.$dbclass.') is not supported by Exponent');
	$dbclass .= '_database';
	$newdb = new $dbclass();
